...
public:
    Deposit();
    Deposit(int id, const QDate& date, double amount, const QString& comment = QString(), int transactionId = -1);
    ...
    // ID of associated savings transaction
